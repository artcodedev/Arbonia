...
const CartItemList: React.FC<CartItemListProps> = ({
  ...
  return (
    <Box>
      <TableContainer>
        <Table sx={{ maxWidth: "1000px", minWidth: "500px" }} size="small">
          <TableHead>
            <TableRow>
          ...
          <TableBody>
            ...
            {consoleType !== "none" && <ConsoleList items={items} />}
      ...
      <Box marginTop="60px">
        ...
        <Typography sx={{ ...styles.smallText }}>
          *Автоматический подбор кронштейнов явялется приблизительным.
          <br />
          Наличие конкретных кронштейнов и их необходимое количество уточнит
          <br />
          продавец при согласовании заказа.
        </Typography>
      </Box>
    </Box>
  );
