...
const ShoppingCart: React.FC<ShoppingCartProps> = () => {
  ...
  useEffect(() => {
    ...
    const localStorageItems: ShoppingCartItem[] = JSON.parse(localStorage.getItem(global.localStorageShoppingCartItemsKey) || "[]");
  ...
  useEffect(() => {
    ...
    localStorage.setItem(
      global.localStorageShoppingCartItemsKey,
      JSON.stringify(shoppingCartContext.state.items)
    );
  }, [shoppingCartContext.state.items]);
