  ...
  return (
    ...
    >
      ...
      <PageHeader
        ...
        description="Двухтрубчатые радиаторы Arbonia 2057 в наличии (высота 57 см). 📦 Склады в Мск и СПб. 🛡️ Официальная гарантия 10 лет. 🚚 Доставка в любой город России."
      />
      <Hero
