  ...
  return (
    ...
    >
      ...
      <PageHeader
        ...
        description="Трехтрубчатые радиаторы Arbonia 3050 в наличии (высота 50 см). 📦 Склады в Мск и СПб. 🛡️ Официальная гарантия 10 лет. 🚚 Доставка в любой город России."
      />
      <Hero
