  ...
  return (
    ...
    >
      ...
      <PageHeader
        ...
        description="Двухтрубчатые радиаторы Arbonia 2050 в наличии (высота 50 см). 📦 Склады в Мск и СПб. 🛡️ Официальная гарантия 10 лет. 🚚 Доставка в любой город России."
      />
      <Hero
